    ...
    (function (global, factory) {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    0 >
                                    (n = (100 / c.width) * (i.clientX - c.left))
                                        ? (n = 0)
                                        : 100 < n && (n = 100),
                                    50 > n
                                        ? (n -= (100 - 2 * n) * a)
        ...
        function toggleClass(element, className, force) {
            if (is.nodeList(element)) {
                return Array.from(element).map((e) =>
                    toggleClass(e, className, force)
                );
            }
        ...
        function matches(element, selector) {
            ...
            function match() {
                return Array.from(document.querySelectorAll(selector)).includes(
                    this
                );
            }
            const method =
        ...
        function validateAspectRatio(input) {
            if (
                !is.array(input) &&
                (!is.string(input) || !input.includes(":"))
            ) {
                return false;
            }
        ...
        const controls = {
            ...
            createProgress(type, attributes) {
                ...
                if (type !== "volume") {
                    ...
                    const suffix = suffixKey
                        ? i18n.get(suffixKey, this.config)
                        : "";
            ...
            updateRangeFill(target) {
                ...
                if (matches(range, this.config.selectors.inputs.seek)) {
                    ...
                    matches(range, this.config.selectors.inputs.volume)
                ) {
            ...
            updateSeekTooltip(event) {
                ...
                let percent = 0;
                const clientRect =
                    this.elements.progress.getBoundingClientRect();
                if (is.event(event)) {
                    percent =
                        (100 / clientRect.width) *
                        (event.pageX - clientRect.left);
                ...
                const point =
                    ...
                    _this$config$markers === void 0
                        ...
                        : (_this$config$markers$ =
                              _this$config$markers.points) === null ||
                          _this$config$markers$ === void 0
                        ? void 0
            ...
            updateSetting(setting, container, input) {
                ...
                // Update the label
                const label = this.elements.settings.buttons[
                    setting
           ...
           options.forEach(option => {
            ...
            setCaptionsMenu() {
                ...
                const options = tracks.map((track, value) => ({
                    value,
                    checked:
                        this.captions.toggled && this.currentTrack === value,
            ...
            toggleMenu(input) {
                ...
                if (is.boolean(input)) {
                    ...
                    if (
                        isMenuItem ||
                        (!isMenuItem && input.target !== button && show)
                    ) {
                        return;
                    }
                }
            ...
            create(data) {
                ...
                dedupe(
                    ...
                    if (control === "progress") {
                        ...
                        // Buffer progress
                        progress.appendChild(
                            createProgress.call(this, "buffer")
                        );
            ...
            setMarkers() {
                ...
                const points =
                    ...
                    _this$config$markers2 === void 0
                        ...
                        : (_this$config$markers3 =
                              _this$config$markers2.points) === null ||
                ...
                const toggleTip = (show) =>
                    toggleClass(tipElement, tipVisible, show);
        ...
        const captions = {
            ...
            update() {
                ...
                const { active, language, meta, currentTrackNode } =
                    this.captions;
        ...
        class Fullscreen {
            constructor(player) {
                ...
                _defineProperty$1(this, "toggleFallback", (toggle = false) => {
                    ...
                    if (browser.isIos) {
                        let viewport = document.head.querySelector(
                            'meta[name="viewport"]'
                        );
                ...
                this.forceFallback =
                    player.config.fullscreen.fallback === "force";
            ...
            static get prefix() {
                ...
                // Check for fullscreen support by vender prefix
                let value = "";
        ...
        class Listeners {
            constructor(_player) {
                ...
                _defineProperty$1(this, "container", () => {
                    ...
                    on.call(
                        ...
                        (event) => {
                            ...
                            // Watch for resizes
                            const method =
                                event.type === "enterfullscreen" ? on : off;
                ...
                _defineProperty$1(this, "media", () => {
                    ...
                    if (
                        player.supported.ui &&
                        player.config.disableContextMenu
                    ) {
                        on.call(
                            player,
                            elements.wrapper,
                ...
                _defineProperty$1(
                    ...
                    (event, defaultHandler, customHandlerKey) => {
                        const { player } = this;
                        const customHandler =
                            player.config.listeners[customHandlerKey];
                ...
                _defineProperty$1(this, "controls", () => {
                    ...
                    this.bind(
                        ...
                        (event) => {
                            ...
                            if (event.key === "Enter") {
                                controls.focusFirstMenuItem.call(
                                    player,
                                    null,
                                    true
                                );
                    ...
                    this.bind(
                        ...
                        (event) => {
                            const rect =
                                elements.progress.getBoundingClientRect();
                            const percent =
                                (100 / rect.width) * (event.pageX - rect.left);
                    ...
                    this.bind(
                        ...
                        (event) => {
                            ...
                            player.currentTime =
                                (seekTo / seek.max) * player.duration;
                        },
                        "seek"
                    );
            ...
            (function (root, factory) {
                ...
                function loadFile(path, callbackFn, args, numTries) {
                    ...
                    if (/(^css!|\.css$)/.test(pathname)) {
                        ...
                        /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(pathname)
                    ) {
                        // image
            ...
            ready() {
                ...
                if (is.empty(source)) {
                    source = player.media.getAttribute(
                        player.config.attributes.embed.id
                    );
                    // hash can also be set as attribute on the <div>
                    hash = player.media.getAttribute(
                        player.config.attributes.embed.hash
                    );
                } else {
                ...
                if (!config.customControls) {
                    fetch(format(player.config.urls.vimeo.api, src)).then(
                        (response) => {
                            ...
                            // Set and show poster
                            ui.setPoster
                                .call(player, response.thumbnail_url)
                                .catch(() => {});
                        }
                    );
                }
                ...
                player.embed.on("loaded", () => {
                    ...
                    if (
                        is.element(player.embed.element) &&
                        player.supported.ui
                    ) {
        ...
        const youtube = {
            ...
            ready() {
                ...
                const currentId =
                    player.media && player.media.getAttribute("id");
                ...
                const container = createElement("div", {
                    id,
                    "data-poster": config.customControls
                        ? player.poster
                        : undefined,
                });
                ...
                player.embed = new window.YT.Player(player.media, {
                    ...
                    playerVars: extend(
                        {},
                        {
                            ...
                            controls:
                                player.supported.ui && config.customControls
                                    ? 0
                                    : 1,
            ...
            constructor(player) {
                        ...
                        this.cuePoints.forEach((cuePoint) => {
                            if (
                                ...
                                if (is.element(seekElement)) {
                                    const cuePercentage =
                                        (100 / this.player.duration) * cuePoint;
                ...
                _defineProperty$1(this, "clearSafetyTimer", (from) => {
                    if (!is.nullOrUndefined(this.safetyTimer)) {
                        this.player.debug.log(
                            `Safety timer cleared from: ${from}`
                        );
        ...
        class PreviewThumbnails {
            ...
            constructor(player) {
                ...
                _defineProperty$1(this, "startMove", (event) => {
                    ...
                    if (event.type === "touchmove") {
                        ...
                        const percentage =
                            ...
                            (event.pageX - clientRect.left);
                        this.seekTime =
                            this.player.media.duration * (percentage / 100);
                        if (this.seekTime < 0) {
                        ...
                        this.elements.thumb.time.innerText = formatTime(
                            this.seekTime
                        );
                        ...
                        const point =
                            (_this$player$config$m =
                                this.player.config.markers) === null ||
                            _this$player$config$m === void 0
                                ? void 0
                                : (_this$player$config$m2 =
                                      _this$player$config$m.points) === null ||
                ...
                _defineProperty$1(this, "render", () => {
                    ...
                    this.elements.thumb.time = createElement(
                        "span",
                        {},
                        "00:00"
                    );
                    timeContainer.appendChild(this.elements.thumb.time);
                    this.elements.thumb.imageContainer.appendChild(
                        timeContainer
                    );
                    ...
                    this.thumbnails.forEach((thumbnail, index) => {
                        if (
                            this.loadedImages.includes(
                                thumbnail.frames[thumbNum].text
                            )
                        ) {
                            qualityIndex = index;
                        }
                ...
                _defineProperty$1(this, "loadImage", (qualityIndex = 0) => {
                    ...
                    if (
                        ...
                        this.currentImageElement.dataset.filename !==
                            thumbFilename
                    ) {
                ...
                _defineProperty$1(
                    this,
                    "preloadNearby",
                    (thumbNum, forward = true) => {
                        return new Promise((resolve) => {
                            setTimeout(() => {
                                const oldThumbFilename =
                                    this.thumbnails[0].frames[thumbNum].text;
                                if (
                                    this.showingThumbFilename ===
                                    oldThumbFilename
                                ) {
                                    ...
                                    if (forward) {
                                        thumbnailsClone =
                                            this.thumbnails[0].frames.slice(
                                                thumbNum
                                            );
                                    } else {
                                        thumbnailsClone =
                ...
                _defineProperty$1(
                    ...
                    (
                        ...
                        if (currentQualityIndex < this.thumbnails.length - 1) {
                            ...
                            if (
                                previewImageHeight < this.thumbContainerHeight
                            ) {
                    ...
                    () => {
                        ...
                        if (!is.empty(input.previewThumbnails)) {
                            ...
                            if (this.config.previewThumbnails.enabled) {
                                this.previewThumbnails = new PreviewThumbnails(
                                    this
                                );
                            }
                        }
            ...
            constructor(target, options) {
                ...
                _defineProperty$1(this, "toggleControls", (toggle) => {
                    ...
                    if (this.supported.ui && !this.isAudio) {
                        ...
                        const force =
                            typeof toggle === "undefined" ? undefined : !toggle;
                            ...
                            if (url.search.length) {
                                ...
                                if (this.isYouTube) {
                                    ...
                                    this.config.youtube.hl =
                                        url.searchParams.get("hl"); // TODO: Should this be setting language?
                                } else {
           ...
           switch (type) {
            ...
            set ratio(input) {
                ...
                if (!is.string(input) || !validateAspectRatio(input)) {
                    this.debug.error(
                        `Invalid aspect ratio specified (${input})`
                    );
                    return;
                }
             ...
             */
            set autoplay(input) {
                this.config.autoplay = is.boolean(input)
                    ? input
