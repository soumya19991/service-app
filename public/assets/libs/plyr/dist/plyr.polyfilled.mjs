    ...
    updateSeekTooltip(event) {
        ...
        const point =
            ...
            _this$config$markers === void 0
                ? void 0
                : (_this$config$markers$ = _this$config$markers.points) ===
                      null || _this$config$markers$ === void 0
                ? void 0
    ...
    setMarkers() {
        ...
        const points =
            ...
            _this$config$markers2 === void 0
                ? void 0
                : (_this$config$markers3 = _this$config$markers2.points) ===
                      null || _this$config$markers3 === void 0
                ? void 0
        ...
        player.embed = new window.YT.Player(player.media, {
            ...
            playerVars: extend(
                {},
                {
                    ...
                    controls:
                        player.supported.ui && config.customControls ? 0 : 1,
    ...
    constructor(player) {
        ...
        _defineProperty$1(this, "startMove", (event) => {
            ...
            if (event.type === "touchmove") {
                ...
                // Get marker point for time
                const point =
                    (_this$player$config$m = this.player.config.markers) ===
                        null || _this$player$config$m === void 0
                        ? void 0
        ...
        _defineProperty$1(this, "showImageAtCurrentTime", () => {
            ...
            this.thumbnails.forEach((thumbnail, index) => {
                if (
                    this.loadedImages.includes(thumbnail.frames[thumbNum].text)
                ) {
                    qualityIndex = index;
                }
            });
            ...
            return new Promise((resolve) => {
                setTimeout(() => {
                    ...
                    if (this.showingThumbFilename === oldThumbFilename) {
                        ...
                        if (forward) {
                            thumbnailsClone =
                                this.thumbnails[0].frames.slice(thumbNum);
                        } else {
