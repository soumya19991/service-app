            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="card-header bg-gradient rounded-top-4 d-flex justify-content-between align-items-center"
                        ...
                        <h4 class="mb-0 fw-semibold">Edit Service</h4>
                        <a href="{{ route('service.index') }}" class="btn btn-sm btn-light fw-semibold">
                            <i class="fa-solid fa-arrow-left"></i> Back
                        </a>
                    </div>

                    <div class="card-body p-4">
                        <form action="{{ route('update.service',$service->id) }}" method="POST" id="serviceForm"
                            novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" class="form-control rounded-4 shadow-sm" rows="4"
                                    placeholder="Write a short description..." required>{{ old('description', $service->description) }}</textarea>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-lg text-white rounded-pill px-5 py-2"
                                    ...
                                    <i class="fa-solid fa-pen-to-square me-2"></i> Update Service
                                </button>
                            </div>
                        </form>
                    </div>
