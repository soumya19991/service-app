...
<head>
    ...
    <link href="./dist/css/tabler.css?1758770977" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PLUGINS STYLES -->
    <link href="./dist/css/tabler-flags.css?1758770977" rel="stylesheet" />
    <link href="./dist/css/tabler-socials.css?1758770977" rel="stylesheet" />
    <link href="./dist/css/tabler-payments.css?1758770977" rel="stylesheet" />
    <link href="./dist/css/tabler-vendors.css?1758770977" rel="stylesheet" />
    <link href="./dist/css/tabler-marketing.css?1758770977" rel="stylesheet" />
    <link href="./dist/css/tabler-themes.css?1758770977" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="./preview/css/demo.css?1758770977" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
...
<body>
    ...
    <script src="./dist/js/tabler-theme.min.js?1758770978"></script>
        ...
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form action="{{ route('logged.login') }}" method="post" autocomplete="off" novalidate>
                        {{-- <div class="mb-3">
    ...
    <script src="./dist/js/tabler.min.js?1758770978" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="./preview/js/demo.min.js?1758770978" defer></script>
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <script>
        /*
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('logged.login') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="email" class="form-label">Email address</label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror"
